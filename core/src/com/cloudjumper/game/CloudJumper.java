...
public class CloudJumper extends Game {
	...
	private void load() {
		...
		assetManager.load(Assets.PLAYER_JUMP.filename, Texture.class);
		assetManager.load(Assets.PLAYER_FALL.filename, Texture.class);
		assetManager.load(Assets.PLAYER_LAND.filename, Texture.class);
		...
		animationManager.load(Assets.PLAYER_JUMP.filename, assetManager.get(Assets.PLAYER_JUMP.filename), 0.040f, Constants.TILE_SIZE, Constants.TILE_SIZE);
		animationManager.load(Assets.PLAYER_FALL.filename, assetManager.get(Assets.PLAYER_FALL.filename), 0.040f, Constants.TILE_SIZE, Constants.TILE_SIZE);
		animationManager.load(Assets.PLAYER_LAND.filename, assetManager.get(Assets.PLAYER_LAND.filename), 0.080f, Constants.TILE_SIZE, Constants.TILE_SIZE);
	}
